		...
		B_NOT_CLOSABLE | B_NOT_ZOOMABLE | B_ASYNCHRONOUS_CONTROLS)
{
	...
	fInfoText = new BStringView(BRect(SPACING, y, 1, 1), NULL, B_TRANSLATE("Volumes to cleanup:"));
	...
	fCleanupButton = new BButton(BRect(0, 0, 0, 0), NULL, B_TRANSLATE("Cleanup selection"),
